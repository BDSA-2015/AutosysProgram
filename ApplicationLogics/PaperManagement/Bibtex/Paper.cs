...
namespace ApplicationLogics.PaperManagement.Bibtex
{
    public class Paper
    {
        ...
        /// </summary>
        public readonly IReadOnlyDictionary<DefaultEnumField, string> Fields;
        /// <summary>
        /// A reference to the resource associated with this Paper (e.g. A PDF, or CSV file...)
        /// </summary>
        public int ResourceRef { get; set; }

        public Paper(DefaultEnumEntry type, IReadOnlyDictionary<DefaultEnumField, string> fields)
        {
            Type = type;
            Fields = fields;
        }
