...
{
    /// <summary>
    ///     This utility class is used to mock db set tables used to test that the repositories write correctly to the
    ///     database.
    ///     Credits goes to our lecturer, Rasmus Lystrøm who wrote the utility class during a lecture.
    ///     EF6 enables mocking Dbsets more easily:
